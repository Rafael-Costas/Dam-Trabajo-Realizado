...
public class Calculadora {
	...
	//Para escrribir en un fichero
		...
		public static void hacerCalculosDeterminado(String fichEntrada, String fichSalida, int limite) throws IOException {
		...
		public static void main(String[] args) {
			...
			try {
				hacerCalculosDeterminado(fichEntrada, fichSal,num);
			} catch (IOException e) {
