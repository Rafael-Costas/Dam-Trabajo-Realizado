...
public class VentanaPrincipal extends JFrame implements ActionListener {
	...
	private void inicio() {
		...
		for (Persona p : lista.getListaPersona()) {
			String elemento = p.getNombre() + "-" + p.getApellido() + "-" + p.getTelefono() + "-" + p.getDireccion();
	...
	private void guardarLista() {
		...
		try {
			...
			escribiendoFichero.writeObject(lista.getListaPersona());
	...
	private ListaPersonas poblarLista() {
		...
		try {
			...
			provisional.setListaPersona( (ArrayList<Persona>) leyendoFichero.readObject() );
