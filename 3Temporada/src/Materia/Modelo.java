...
public class Modelo {
	...
	//construimos almacenes (depos) para bebidas y monedas
	public Almacen Deposito1Euro = new Almacen(8, "euro");
	public Almacen Deposito01Euro = new Almacen(15,"10cent");
	...
	public void PonPrecios (float CocaCola, float Naranja,
	float Agua) {
