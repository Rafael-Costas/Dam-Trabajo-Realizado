...
// * caso contrario
	...
	public static boolean IntroduccionMonedas(Modelo Maquina, float Precio) {
		...
		String Accion;
		char Car;
		boolean Pagado = false, Anulado = true;
		float Acumulado = 0;

		do {
			System.out.println("-- u( mete 1 euro) ,d (mete 10 centimos) ,a(anula la operacion) --");
...
//falta de precision
 ...
 // cantidad la multiplica por 10 (10 vexes 10 centimos hacen un euro)
 Monedas01 = (int) Math.floor((double) Cantidad*10f);
 return (Maquina.Deposito1Euro.getNumeroDeElementos()>=Monedas1)&& (Maquina.Deposito01Euro.getNumeroDeElementos()>=Monedas01);
 }
